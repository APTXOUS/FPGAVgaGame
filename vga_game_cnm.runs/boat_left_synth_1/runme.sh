...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/boat_left_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boat_left.vds -m64 -mode batch -messageDb vivado.pb -notrace -source boat_left.tcl
