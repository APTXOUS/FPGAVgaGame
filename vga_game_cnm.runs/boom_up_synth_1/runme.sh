...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/boom_up_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boom_up.vds -m64 -mode batch -messageDb vivado.pb -notrace -source boom_up.tcl
