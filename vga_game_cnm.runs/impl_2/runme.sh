...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log game_main.vdi -applog -m64 -messageDb vivado.pb -mode batch -source game_main.tcl -notrace
