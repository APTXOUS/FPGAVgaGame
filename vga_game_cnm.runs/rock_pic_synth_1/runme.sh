...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/rock_pic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rock_pic.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rock_pic.tcl
