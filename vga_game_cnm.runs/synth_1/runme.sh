...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_main.vds -m64 -mode batch -messageDb vivado.pb -notrace -source game_main.tcl
