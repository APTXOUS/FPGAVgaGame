...
HD_PWD='C:/Users/youyaoyin/vga_game_cnm/vga_game_cnm.runs/boat_down_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boat_down.vds -m64 -mode batch -messageDb vivado.pb -notrace -source boat_down.tcl
