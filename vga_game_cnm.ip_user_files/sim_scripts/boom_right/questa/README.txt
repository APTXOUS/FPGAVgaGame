...
#
# Generated by export_simulation on Tue Jan 02 02:22:55 +0800 2018
#
################################################################################
...
switch to the './boom_right.sh' script.

./boom_right.sh -reset_run
...
./boom_right.sh -noclean_files

For more information on the script, please type './boom_right.sh -help'.
