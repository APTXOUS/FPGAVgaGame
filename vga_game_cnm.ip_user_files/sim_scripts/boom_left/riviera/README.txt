...
#
# Generated by export_simulation on Tue Jan 02 02:21:59 +0800 2018
#
################################################################################
...
switch to the './boom_left.sh' script.

./boom_left.sh -reset_run
...
./boom_left.sh -noclean_files

For more information on the script, please type './boom_left.sh -help'.
