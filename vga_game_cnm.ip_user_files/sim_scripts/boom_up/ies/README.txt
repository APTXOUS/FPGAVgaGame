...
#
# Generated by export_simulation on Tue Jan 02 00:33:42 +0800 2018
#
################################################################################
...
switch to the './boom_up.sh' script.

./boom_up.sh -reset_run
...
./boom_up.sh -noclean_files

For more information on the script, please type './boom_up.sh -help'.
