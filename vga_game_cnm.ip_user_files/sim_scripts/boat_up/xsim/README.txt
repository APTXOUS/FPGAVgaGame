...
#
# Generated by export_simulation on Mon Jan 01 21:00:17 +0800 2018
#
################################################################################
...
switch to the './boat_up.sh' script.

./boat_up.sh -reset_run
...
./boat_up.sh -noclean_files

For more information on the script, please type './boat_up.sh -help'.
