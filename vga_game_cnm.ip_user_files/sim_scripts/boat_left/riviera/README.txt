...
#
# Generated by export_simulation on Mon Jan 01 21:02:11 +0800 2018
#
################################################################################
...
switch to the './boat_left.sh' script.

./boat_left.sh -reset_run
...
./boat_left.sh -noclean_files

For more information on the script, please type './boat_left.sh -help'.
